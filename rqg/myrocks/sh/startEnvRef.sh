...
# start test server
   ...
   ./mysqld --defaults-file=$testDir1/testdbtst.cnf --rocksdb_strict_collation_exceptions=.* &
   sleep 5
#
# start reference server
   cd $testDir2/mysql-5.6/sql
   ./mysqld --defaults-file=$testDir2/testdbref.cnf --rocksdb_strict_collation_exceptions=.* &
#
# End of script
