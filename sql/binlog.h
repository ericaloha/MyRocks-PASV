...
class HybridLogicalClock {
 public:
  explicit HybridLogicalClock(uint64_t start) {
    current_= start;
  }
...
public:
  ...
  */
  ...
  uint64_t get_current_hlc() {
    return hlc.get_current();
  }
  ...
  uint64_t update_hlc(uint64_t minimum_hlc) {
...
private:
  ...
  /* Hybrid logical clock for this instance.
