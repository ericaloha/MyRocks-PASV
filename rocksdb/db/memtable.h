...
class MemTable {
 public:
  ...
  void ShouldForceFlush_kc_(){should_flush=1;}
  //void ShouldNotForceFlush_kc_(){should_flush=0;}
  int NeedForceFlushOrNot_kc_(){return should_flush;}
  void AfterForceFlush_kc_(){should_flush=0;}
 ...
 private:
  ...
  int should_flush=0; //0--> should not flush, 1--> should flush
  ...
  bool ShouldFlushNow();
  // Returns a heuristic flush decision --kc, for active flush
  bool ShouldFlushNow_kc();

  // Updates flush_state_ using ShouldFlushNow()
  int UpdateFlushState_();
  void UpdateFlushState();
  void UpdateFlushState_init();
  void UpdateFlushState_kc();
